...
specialization: [Fullstack Web developer, DevOps, Data Analyst]
current_position: Senior Support Coodinator @ ENEO CAMEROON SA
...
| 🔒 **OpenRisk** |  Unified Risk & Threat Intelligence Management Platform | `Python` `Kubernetes` `Javascript` `OpenRMF` `OpenCTI` `TheHive` | [Live Demo →](https://alex-dembele.github.io/OpenRisk/) |
